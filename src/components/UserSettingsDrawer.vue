<template>
  ...
  <div class="flex-1 overflow-y-auto p-4 space-y-6">
      ...
      <div class="mb-4">
        ...
        <div class="flex gap-2">
          ...
          <button
            ...
            :disabled="isSavingEmail || !emailInput.trim() || emailInput === authStore.user?.email"
      ...
      <div class="bg-gray-800 rounded-lg p-3 border border-gray-700">
        ...
        <div class="space-y-2">
          ...
          <input
            ...
            class="w-full px-3 py-2 bg-gray-900 border rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm"
            :class="passwordMismatch ? 'border-red-500' : 'border-gray-700'"
          ...
          <button
            ...
            :disabled="isSavingPassword || !newPassword || passwordMismatch"
          ...
          >{{ isSavingPassword ? 'Updating…' : 'Update password' }}</button>
        </div>
      </div>
    </section>
        ...
        <div v-for="toggle in displayToggles" :key="toggle.key" class="bg-gray-800 rounded-lg p-3 border border-gray-700">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="toggle.value() ? 'bg-blue-600' : 'bg-gray-600'"
              role="switch"
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 ml-4">
              <button
                ...
                class="w-7 h-7 flex items-center justify-center rounded bg-gray-700 text-gray-300 hover:text-white disabled:opacity-30 transition-colors text-xs font-bold"
              >A−</button>
        ...
        <div class="bg-gray-800 rounded-lg p-3 border border-gray-700">
          ...
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="px-3 py-1.5 bg-blue-600 text-white text-xs rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-1.5"
            >
      ...
      <div class="bg-gray-800 rounded-lg p-3 border border-gray-700 space-y-3">
        <div>
          ...
          <input
            ...
            type="text"
            maxlength="1"
            class="w-16 px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:outline-none text-center font-mono text-sm"
            placeholder="—"
          />
        </div>
    ...
    <section>
      <button
        @click="handleReset"
        class="w-full bg-gray-800 rounded-lg p-3 border border-gray-700 hover:bg-gray-750 transition-colors text-left flex items-center gap-3"
      >
...
const displayToggles = [
  {
    key: 'tags',
    label: I18N.SETTINGS.SHOW_TAGS,
    desc: I18N.SETTINGS.SHOW_TAGS_DESC,
    value: () => settingsStore.showTagsInLists,
    toggle: () => settingsStore.toggleShowTagsInLists(),
  },
  {
    key: 'lists',
    label: I18N.SETTINGS.SHOW_LISTS,
    desc: I18N.SETTINGS.SHOW_LISTS_DESC,
    value: () => settingsStore.showListsInLists,
    toggle: () => settingsStore.toggleShowListsInLists(),
  },
  {
    key: 'artists',
    label: I18N.SETTINGS.SHOW_ARTISTS,
    desc: I18N.SETTINGS.SHOW_ARTISTS_DESC,
    value: () => settingsStore.showArtistsInLists,
    toggle: () => settingsStore.toggleShowArtistsInLists(),
  },
  {
    key: 'lyrics',
    label: I18N.SETTINGS.SHOW_LYRICS_ON_TAP,
    desc: I18N.SETTINGS.SHOW_LYRICS_ON_TAP_DESC,
    value: () => settingsStore.songClickShowsLyrics,
    toggle: () => { settingsStore.songClickShowsLyrics = !settingsStore.songClickShowsLyrics },
  },
]
